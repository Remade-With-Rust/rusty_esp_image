...
[![Remade With Rust](https://img.shields.io/badge/Remade%20With-Rust-000?logo=rust&logoColor=fff)](https://github.com/remade-with-rust) [![By Mata Network](https://img.shields.io/badge/by-Mata%20Network-5b2be0)](https://www.mata.network) [![crates.io](https://img.shields.io/crates/v/rusty_esp_image-esp.svg)](https://crates.io/crates/rusty_esp_image-esp) [![docs.rs](https://docs.rs/rusty_esp_image-esp/badge.svg)](https://docs.rs/rusty_esp_image-esp) [![License: MIT OR Apache-2.0](https://img.shields.io/badge/license-MIT%20OR%20Apache--2.0-blue)](https://github.com/Remade-With-Rust/rusty_esp_image/blob/main/LICENSE-MIT)

The chip backends for the camera package: the vendor's camera component bound exactly once, behind the image-source seam, so nothing above it knows a C component exists.
